...
export const municipalities: Municipality[] = [
  ...
  { slug: "beloeil", name: "Beloeil", region: "Grand Montréal" },
  { slug: "varennes", name: "Varennes", region: "Grand Montréal" },
  ...
  { slug: "sainte-therese", name: "Sainte-Thérèse", region: "Grand Montréal" },
  { slug: "lachenaie", name: "Lachenaie", region: "Grand Montréal" },
  { slug: "deux-montagnes", name: "Deux-Montagnes", region: "Grand Montréal" },

  // Grand Québec
  { slug: "quebec", name: "Québec", region: "Grand Québec" },
  { slug: "levis", name: "Lévis", region: "Grand Québec" },
  { slug: "beauport", name: "Beauport", region: "Grand Québec" },
  { slug: "charlesbourg", name: "Charlesbourg", region: "Grand Québec" },
  { slug: "sainte-foy", name: "Sainte-Foy", region: "Grand Québec" },
  { slug: "cap-rouge", name: "Cap-Rouge", region: "Grand Québec" },
  { slug: "saint-augustin-de-desmaures", name: "Saint-Augustin-de-Desmaures", region: "Grand Québec" },
  { slug: "l-ancienne-lorette", name: "L'Ancienne-Lorette", region: "Grand Québec" },
  ...
  { slug: "valleyfield", name: "Salaberry-de-Valleyfield", region: "Montérégie" },
]
