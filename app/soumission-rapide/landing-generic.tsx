...
export function SoumissionRapideLandingGeneric() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFF6]" style={{ fontFamily: "'Source Serif 4', 'Source Serif Pro', Georgia, serif" }}>
      ...
      <section className="bg-[#FFFFF6] px-4 pt-2 pb-0 lg:p-[60px]">
        ...
        <div className="relative rounded-[20px] overflow-hidden shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] lg:h-[700px] flex flex-col lg:flex-row items-stretch lg:items-center justify-between lg:px-[40px] lg:py-[50px]">
          ...
          <div className="absolute inset-0">
            <Image src="/images/hero-iso.jpg" alt="Isolation résidentielle au Québec" fill className="object-cover" priority />
          ...
          <div className="relative z-10 flex-1 flex flex-col gap-3 lg:gap-[32px] items-start justify-center px-5 py-5 lg:px-[20px] lg:py-[64px] min-w-0">
            ...
            <div className="inline-flex items-center gap-1 bg-[#aedee5] rounded-full pl-3 pr-2 py-1 lg:py-1.5 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] self-start max-w-full overflow-hidden">
              <span className="font-bold text-[12px] md:text-[18px] text-[#002042] tracking-[-0.5px] md:tracking-[-0.72px] truncate">
                Entrepreneurs certifiés RBQ partout au Québec
              </span>
            ...
            <div className="drop-shadow-[0px_0px_4px_rgba(0,0,0,0.4)]">
              <h1 className="text-[28px] sm:text-[40px] lg:text-[56px] font-semibold text-[#FFFFF6] tracking-[-1.2px] lg:tracking-[-2.24px] leading-[1.1]" style={{ fontFamily: "'Radio Canada Big', 'Inter', sans-serif" }}>
                ...
                {" "}d'entrepreneurs certifiés en moins de 48h.
              </h1>
            </div>
      ...
      <section className="bg-[#FFFFF6] py-[60px] px-4">
        <div className="max-w-[1024px] mx-auto flex flex-col gap-[40px] items-center">

          {/* Heading */}
          <div className="flex flex-col gap-[32px] items-center w-full">
            <h2 className="font-bold text-[40px] text-[#10002C] text-center tracking-[-1.2px] leading-[1.2]" style={{ fontFamily: "'Radio Canada Big', 'Inter', sans-serif" }}>
              Ce que nous faisons pour vous
            </h2>
            <p className="font-semibold text-[20px] text-[#375371] text-center tracking-[-0.8px] leading-[1.2] max-w-[900px]">
            ...
            <div className="flex flex-wrap gap-[24px] items-start justify-center w-full">
              {[
                ...
                <div
                  key={card.title}
                  className="bg-white border border-[#eef5fc] rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex-1 min-w-[240px] h-[280px] p-[32px] flex flex-col gap-[16px] items-start"
                >
                  {/* Icon badge */}
                  <div className="bg-[#f7fceb] border border-[#b9e15c] rounded-full size-[48px] p-[4px] flex items-center justify-center shrink-0">
                    <span className="text-[24px] leading-none">{card.emoji}</span>
                  </div>
                  <p className="font-bold text-[20px] text-[#10002C] tracking-[-0.8px] leading-[1.2]">
                    {card.title}
                  </p>
                  <p className="text-[18px] text-[#375371] tracking-[-0.72px] leading-[1.2]">
                    {card.desc}
                  </p>
                </div>
              ))}
            ...
            {/* Mockup résultats */}
            <div className="w-full rounded-[20px] overflow-hidden bg-[#eef5fc] p-6 lg:p-10 flex flex-col gap-4">
              <div className="bg-white rounded-[16px] shadow-sm p-6 flex flex-col gap-4">
                <h3 className="font-bold text-[20px] text-[#10002C] text-center tracking-[-0.8px]" style={{ fontFamily: "'Radio Canada Big', sans-serif" }}>
                  Votre rapport détaillé
                </h3>
                <div className="flex flex-wrap gap-3">
                  {[
                    { label: "Surface de toit", value: "9 255 pi²" },
                    { label: "Sections de toit", value: "12" },
                    { label: "Complexité", value: "Modérée" },
                  ].map((stat) => (
                    <div key={stat.label} className="bg-[#f8f9fa] border border-[#e8e8e0] rounded-[12px] px-4 py-3 flex flex-col gap-1 flex-1 min-w-[120px]">
                      <span className="text-[12px] text-[#375371]">{stat.label}</span>
                      <span className="font-bold text-[18px] text-[#10002C] tracking-[-0.5px]">{stat.value}</span>
                    </div>
                  ))}
                </div>

                <div className="border-2 border-[#b9e15c] rounded-[16px] p-5">
                  <h4 className="font-bold text-[18px] text-[#10002C] text-center tracking-[-0.7px] mb-4" style={{ fontFamily: "'Radio Canada Big', sans-serif" }}>
                    Comparez vos trois soumissions
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {[
                      { num: "1", rating: "4.4", price: "5 321.23 $ – 6 982.55 $", features: ["Valeur R: 3,2-4,2 par pouce", "Installation rapide", "Bon rapport qualité-prix", "Résistant au feu", "Épaisseur: ~12 pouces", "Durabilité: 20-25 ans"] },
                      { num: "2", rating: "4.7", price: "7 345.95 $ – 8 350.00 $", features: ["Valeur R: 3,6-3,8 par pouce", "Matériau écologique (recyclé)", "Excellente insonorisation", "Traitement anti-feu et anti-moisissure", "Épaisseur: ~15 pouces", "Durabilité: 25-30 ans"] },
                      { num: "3", rating: "4.9", price: "8 343.56 $ – 12 932.38 $", features: ["Valeur R: 3,6-3,8 par pouce", "Matériau écologique (recyclé)", "Excellente insonorisation", "Traitement anti-feu et anti-moisissure", "Épaisseur: ~15 pouces", "Durabilité: 25-30 ans"] },
                    ].map((e) => (
                      <div key={e.num} className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[14px] text-[#10002C]">Entrepreneur {e.num}</span>
                          <span className="text-[12px] text-[#375371]">⭐ {e.rating}</span>
                        </div>
                        <div>
                          <span className="text-[11px] text-[#375371]">Prix total</span>
                          <p className="font-bold text-[14px] text-[#10002C]">{e.price}</p>
                        </div>
                        <div className="h-1.5 rounded-full bg-[#b9e15c]" />
                        <div className="flex flex-col gap-1">
                          <span className="text-[11px] font-semibold text-[#10002C]">Caractéristiques :</span>
                          {e.features.map((f) => (
                            <div key={f} className="flex items-start gap-1">
                              <CheckCircle className="w-3 h-3 text-[#b9e15c] mt-0.5 shrink-0" />
                              <span className="text-[11px] text-[#375371]">{f}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                ...
                <div className="border border-[#b9e15c] bg-[#f7fceb] rounded-[12px] p-4">
                  <p className="text-[14px] text-[#375371]">Selon notre analyse vous pourriez économiser jusqu'à :</p>
                  <p className="font-bold text-[22px] text-[#b9e15c] tracking-[-0.5px]">526 $ par année ! 🎉</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1024px] mx-auto flex flex-col gap-[32px] items-center">
          ...
          <div className="flex flex-wrap gap-[24px] items-start justify-center w-full">
            {[
              {
                step: "1",
                title: "Validation de la licence RBQ",
                desc: "Nous vérifions que l'entrepreneur détient une licence RBQ valide et conforme pour les travaux d'isolation.",
                img: "/images/verification-rbq.png",
                imgAlt: "Registre RBQ",
              },
              {
                step: "2",
                title: "Analyse du dossier de l'entreprise",
                desc: "Nous consultons les informations publiques disponibles pour détecter d'éventuels litiges, plaintes ou problèmes récurrents.",
                img: "/images/verification-liste-1.png",
                imgAlt: "Liste de vérification",
              },
              {
                step: "3",
                title: "Analyse des avis et commentaires",
                desc: "Nous analysons les avis Google et les commentaires des clients pour nous assurer que l'entrepreneur maintient une bonne réputation.",
                img: "/images/verification-google.png",
                imgAlt: "Avis Google",
              },
              {
                step: "4",
                title: "Entretien avec l'entrepreneur",
                desc: "Nous discutons avec chaque entrepreneur avant de l'intégrer au réseau.",
                img: "/images/verification-facetime.png",
                imgAlt: "Entretien vidéo",
              },
              {
                step: "5",
                title: "Suivi avec les clients",
                desc: "Après les projets, nous faisons un suivi auprès des clients pour nous assurer qu'ils sont satisfaits du travail réalisé.",
                img: "/images/verification-liste-2.png",
                imgAlt: "Sondage de satisfaction",
              },
            ].map((card) => (
