...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `Isolation à ${municipality.name} | 3 Soumissions Gratuites d'Entrepreneurs Certifiés`
  const description = `Comparez 3 soumissions d'entrepreneurs en isolation certifiés RBQ à ${municipality.name}. Service gratuit, entrepreneurs vérifiés et interviewés par notre équipe. Réponse en moins de 48h.`
